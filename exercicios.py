...
## 2. Faça um programa que leia um número inteiro fornecido pelo usuário. Se esse número 
##   for positivo, calcule a raiz quadrada do número e apresente-a. Se o número for negativo, 
